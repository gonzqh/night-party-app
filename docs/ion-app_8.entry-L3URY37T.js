...
import {
  transition
} from "./chunk-NEEN7ETG.js";
import {
  findIonContent,
  getScrollElement,
  printIonContentErrorMsg
} from "./chunk-MBWVDNWU.js";
import "./chunk-KJBBQORM.js";
import {
  createLockController
} from "./chunk-2UQX67QP.js";
import {
  attachComponent,
  detachComponent
} from "./chunk-4N4QBHLX.js";
import {
  createColorClasses,
  hostContext
} from "./chunk-G4QZH5KV.js";
...
} from "./chunk-MPW7DZGH.js";
import {
  shouldUseCloseWatcher
} from "./chunk-ZGR2OMIN.js";
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-JCIZIARR.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-5KCV36RE.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-AaDhOpKN-NIOLBXMJ.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CTe4XmL7-RJIO6V5E.js");
        ...
        if (typeof window !== "undefined") {
          import("./keyboard-ywgs5efA-6YWZICGD.js").then((module) => module.startKeyboardAssist(window));
        }
        import("./focus-visible-BmVRXR1y-SBSLH56O.js").then((module) => this.focusVisible = module.startFocusVisible());
      }));
    }
  }
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BZBFwTQV-GACZFPPZ.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
@ionic/core/dist/esm/ion-app_8.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-app_8.entry-L3URY37T.js.map
