...
function ToditoPage_div_43_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r2.getPunishemntTypes);
  }
}
var _ToditoPage = class _ToditoPage {
  ...
  get getPunishemntTypes() {
    return ALTERNATIVE_PUNISHMENTS.filter((p) => this.game.punishments.some((gp) => gp.type === p.type));
  }
  get currentPlayer() {
